...
extension FileManager {
    ...
    public func createAndProtectDirectory(at url: URL) {
        ...
        if !fileExists(atPath: url.path) {
            do {
                ...
                fatalError("Failed to create directory: \(url), error: \(error)")
            }
        }
    ...
    public func setProtectionUntilFirstUserAuthentication(_ url: URL) {
        do {
            ...
            fatalError("Failed to set protection until first user authentication: \(url), error: \(error)")
        }
    }
...
public extension URL {
    ...
    public func excludeFromBackup() {
        ...
        do {
            ...
            fatalError("Error excluding: \(mutableCopy), from backup: \(error)")
        }
    }
